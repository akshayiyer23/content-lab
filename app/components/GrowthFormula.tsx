...
const steps = [
  {
    num: '01',
    label: 'Open Loop Caption',
    detail: 'Creates a question the video must answer',
    metric: '2,344% view lift',
    color: '#6c47ff',
  },
  {
    num: '02',
    label: 'Trending or Original Sound',
    detail: 'Trending = reach. Original = higher follow rate.',
    metric: '0.75% follow rate',
    color: '#8b5cf6',
  },
  {
    num: '03',
  ...
  },
  {
    ...
    detail: 'Replay value = strongest growth signal',
    metric: '29,573 total saves',
    color: '#ff5c1a',
  },
  {
    num: '05',
    label: 'Result',
    detail: '~526 follows per 1,000 saves',
    metric: '645K views peak',
    color: '#ff5c1a',
    isResult: true,
  },
]
